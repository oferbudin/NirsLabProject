...
class Paths:
    ...
    def __init__(self, subject: str):
        ...
        self.subject_plots_dir_path = os.path.join(self.subject_products_dir_path, 'plots')
        self.subject_spikes_dir_path = os.path.join(self.subject_products_dir_path, 'spikes')
